...
# “senescent”.
age_class_value <- function(age_class) {
  if (age_class == "egg") {
    return(10)
  } else if (age_class == "larva") {
    return(5)
...
age_class_value("egg")
age_class_value("larva")
age_class_value( "adult")
age_class_value("senescent")
...
a <- 5.243e-6
b <- 3.141
shark_lengths <- c(100, 200, 300)
masses <- a * shark_lengths^b
